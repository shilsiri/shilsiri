...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        reprompt_text = "I was born on 4th August. 2014. When were you born?"
...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        day = slots["day"].value
        url= "https://docs.google.com/spreadsheets/d/e/2PACX-1vRatT9xmrA4eMtJpATg3lX7z17_PaHTHDaV33ezhosnOiqk_DxF18lqXOy0A1hgg2hnHxo__Chr9yum/pub?gid=1439203652&single=true&output=csv"
